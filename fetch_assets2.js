...
// 更多不同领域的关键词
const keywords = ['security', 'jwt', 'oauth', 'redis', 'mongodb', 'elasticsearch', 'kafka', 'graphql', 'rest', 'grpc', 'linux', 'shell', 'git', 'CI', 'CD', 'nginx', 'apache', 'aws', 'azure', 'gcp'];
const results = [];
